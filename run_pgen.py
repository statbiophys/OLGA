#!/usr/bin/env python2
# -*- coding: utf-8 -*-
"""Command line executable function to compute Pgens of sequences from file.
...
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --VDJ_model_folder models/human_T_beta/
...
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB -m 250

#Read in amino acid sequences (which happen to be in the column of index 1 (second column) in example_seqs.txt)
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --seq_in_index 1 -m 250
...
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB -a expanded_alphabet_files/example_expanded_amino_acid_alphabet.txt -m 250

#Read in nucleotide sequences but only run Pgen on the translated amino acid sequences
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --seq_type ntseq --seq_type_out aaseq -m 250

#Compute Pgen conditioned on the V and J gene/alleles provided in columns of index 2 and 3.
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB -v 2 -j 3 -m 250

#Turn the sequence display off
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --display_seqs_off -m 250

#Change sequence display to 20 sequences (default is 50)
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --num_lines_for_display 20 -m 250

#Skip the first 5 lines
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --lines_to_skip 5 -m 250

#Safe mode off
./run_pgen.py data/example_seqs.txt results/example_pgen.txt --humanTCRB --seq_type ntseq --safe_mode_off -m 250
